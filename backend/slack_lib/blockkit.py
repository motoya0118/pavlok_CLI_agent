...
class BlockKitBuilder:
    ...
    def plan_open_notification(
        ...
        blocks: list[dict[str, Any]] = [
            {
                "type": "header",
                "text": {"type": "plain_text", "text": "📅 今日の予定を登録しましょう"},
            },
        ]
            ...
            [
                ...
                },
                {
                    ...
                    "elements": [
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "📝 予定を登録"},
                            "style": "primary",
    ...
    def plan_submit_confirmation(
        scheduled_tasks: list[dict[str, str]], next_plan: dict[str, str]
    ) -> list[dict[str, Any]]:
        ...
        return [
            {
                "type": "header",
                "text": {"type": "plain_text", "text": "📅 本日の予定を登録しました"},
            },
            {"type": "section", "text": {"type": "mrkdwn", "text": task_list_text}},
            {
                "type": "section",
                "text": {
                    "type": "mrkdwn",
            ...
            {
                "type": "context",
                "elements": [{"type": "mrkdwn", "text": "💡 各時刻にリマインドされます"}],
            },
        ]
    ...
    def remind_notification(
        ...
        return [
            {"type": "header", "text": {"type": "plain_text", "text": "🔔 リマインド"}},
            {"type": "divider"},
            {
                "type": "section",
                "text": {
                ...
                "elements": [
                    {
                        ...
                        "value": json.dumps(
                            {"schedule_id": schedule_id, "event_type": "remind"}, ensure_ascii=False
                        ),
                    },
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "✕ やれません"},
                        "style": "danger",
                        "action_id": "remind_no",
                        "value": json.dumps(
                            {"schedule_id": schedule_id, "event_type": "remind"}, ensure_ascii=False
    ...
    @staticmethod
    def no_response(
        task_name: str, no_count: int, punishment_mode: str, punishment_value: int, comment: str
    ) -> list[dict[str, Any]]:
        ...
        return [
            ...
            {
                "type": "context",
                "elements": [{"type": "mrkdwn", "text": "⚡ Pavlokから刺激を送信しました"}],
            },
        ]
    ...
    def ignore_notification(
        ...
        """ignore検知通知（パブリック）"""
        return [
            {"type": "header", "text": {"type": "plain_text", "text": "⚠️ 応答待ち"}},
            {"type": "divider"},
            {
                "type": "section",
                "text": {
            ...
            {"type": "divider"},
            {
                ...
                "elements": [
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "✓ 今やりました！"},
                        "style": "primary",
                        "action_id": "ignore_yes",
                        "value": json.dumps(
                            {"schedule_id": schedule_id, "event_type": "ignore"}, ensure_ascii=False
                        ),
                    },
                    {
                        "type": "button",
    ...
    def auto_canceled_notification(
        task_name: str, task_time: str, final_punishment_mode: str, final_punishment_value: int
    ) -> list[dict[str, Any]]:
        """最大無視到達時（キャンセル通知）"""
        return [
            {"type": "header", "text": {"type": "plain_text", "text": "❌ 自動キャンセル"}},
            {"type": "divider"},
            {
                "type": "section",
                "text": {
    ...
    def restart_notification() -> list[dict[str, Any]]:
        ...
        return [
            {"type": "section", "text": {"type": "mrkdwn", "text": "▶️ *鬼コーチを再開しました*"}},
            {
                "type": "context",
                "elements": [
                    {"type": "mrkdwn", "text": "次回のWorkerサイクルから通常運用が再開されます"}
                ],
            },
        ]
    ...
    def base_commit_modal(commitments: list[dict[str, str]]) -> dict[str, Any]:
            ...
            blocks.append(
                {
                    ...
                    "label": {"type": "plain_text", "text": f"コミットメント {idx}"},
                    "element": {
                        "type": "plain_text_input",
                        "action_id": f"task_{idx}",
                        "initial_value": commitment.get("task", ""),
                        "placeholder": {"type": "plain_text", "text": "タスク名"},
                        "max_length": 100,
                    },
            ...
            blocks.append(
                {
                    ...
                    "label": {"type": "plain_text", "text": f"時刻 {idx}"},
                    "element": {
                        "type": "timepicker",
                        "action_id": f"time_{idx}",
                        "initial_time": commitment.get("time", "07:00"),
                        "placeholder": {"type": "plain_text", "text": "時間を選択"},
                    },
                    "optional": True,
                }
            )
        ...
        return {
            ...
            "title": {"type": "plain_text", "text": "📋 コミットメント管理"},
    ...
    def config_modal(config_values: dict[str, str]) -> dict[str, Any]:
        """設定管理モーダル"""
        blocks = [
            {"type": "header", "text": {"type": "plain_text", "text": "🔴 罰設定"}},
            {
                "type": "input",
                "block_id": "PAVLOK_TYPE_PUNISH",
                "label": {"type": "plain_text", "text": "デフォルト罰スタイル"},
                "element": {
                    "type": "static_select",
            ...
            },
            {
                ...
                "label": {"type": "plain_text", "text": "最大ZAP強度 (安全リミット)"},
                "element": {
                    "type": "plain_text_input",
            ...
            {"type": "divider"},
            {"type": "header", "text": {"type": "plain_text", "text": "🔔 通知設定"}},
            {
                "type": "input",
                "block_id": "PAVLOK_TYPE_NOTION",
                "label": {"type": "plain_text", "text": "通知時のPavlokタイプ"},
                "element": {
                    "type": "static_select",
            ...
            },
            {
                ...
                "label": {"type": "plain_text", "text": "通知時のPavlok強度 (0-100)"},
                "element": {
                    "type": "plain_text_input",
            ...
            {"type": "divider"},
            {"type": "header", "text": {"type": "plain_text", "text": "⚡ Ignoreモード設定"}},
            {
                "type": "input",
                "block_id": "IGNORE_INTERVAL",
                "label": {"type": "plain_text", "text": "検知間隔 (秒)"},
                "element": {
                    "type": "static_select",
            ...
            },
            {
                ...
                "label": {"type": "plain_text", "text": "最大再試行回数"},
                "element": {
                    "type": "plain_text_input",
            ...
            {"type": "divider"},
            {"type": "header", "text": {"type": "plain_text", "text": "💬 コーチ口調設定"}},
            {
                "type": "input",
                "block_id": "COACH_CHARACTOR",
                "label": {"type": "plain_text", "text": "キャラクター"},
                "element": {
                    "type": "plain_text_input",
                    "action_id": "COACH_CHARACTOR_input",
                    "initial_value": config_values.get(
                        "COACH_CHARACTOR", "うる星やつらのラムちゃん"
                    ),
                    "placeholder": {"type": "plain_text", "text": "例: うる星やつらのラムちゃん"},
                    "min_length": 1,
                    "max_length": 100,
                },
            },
            {"type": "divider"},
            {
                ...
                "elements": [
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "🔄 全リセット"},
                        "style": "danger",
                        ...
                        "confirm": {
                            ...
                            "confirm": {"type": "plain_text", "text": "リセット"},
                            "deny": {"type": "plain_text", "text": "キャンセル"},
                        },
                    },
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "📋 変更履歴"},
        ...
        return {
            ...
            "title": {"type": "plain_text", "text": "⚙️ Oni System 設定"},
    ...
    def error_notification(error_message: str) -> list[dict[str, Any]]:
        """エラー通知"""
        return [
            {"type": "header", "text": {"type": "plain_text", "text": "❌ エラーが発生しました"}},
    ...
    def daily_limit_reached(limit_count: int) -> list[dict[str, Any]]:
        """日次最大ZAP到達通知"""
        return [
            {"type": "header", "text": {"type": "plain_text", "text": "🛑 本日の罰上限に到達"}},
            {
                "type": "section",
                "text": {
                    "type": "mrkdwn",
